...
function Projects() {
  ...
  return(
    <div className='projects' style={{ backgroundColor:`${currentTheme.pageColor}` }}>
      <div data-relative-input='true' data-hover-only='true' id='scene' className='projects-intro'>
      ...
      <div className='technical-projects' style={{ color:`${currentTheme.fontColor}` }}>
        ...
        <p style={{ fontSize:'20px', textAlign:'center' }}>{ technicalProjects.General }</p>
      </div>
      <div className='illustrations' style={{ color:`${currentTheme.fontColor}` }}>
        <h1 className='illustrations-title'>Illustrations</h1>
        <p style={{ fontSize:'20px', textAlign:'center' }}>{ illustrations.General }</p>
        <IllustrationList /> 
      </div>
      <Footer />
    </div>
